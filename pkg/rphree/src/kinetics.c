...
static char const svnid[] =
	"$Id: kinetics.c 3985 2010-02-01 16:48:18Z dlpark $";
 ...
 */
	...
	{
	  // MDL:
	  // Rprintf("set_and_run, state=%d\n",state);
	  // Rprintf("step_fraction=%f\n",step_fraction);
	  if (R_step (step_fraction) == MASS_BALANCE)
		{
			return (MASS_BALANCE);
		}
	  // Rprintf("set_and_run, after R_step()\n");
/*
