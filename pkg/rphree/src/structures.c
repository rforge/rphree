...
static char const svnid[] =
	"$Id: structures.c 3985 2010-02-01 16:48:18Z dlpark $";
...
/* miscellaneous work space */
	...
	// MDL: line and line_save can now normally be deallocated
...
#ifdef RphreeDEBUG
  Rprintf (": deb :: clean_up after PHRQ_free_all\n");
#endif
 ...
 *      return: RLIB_ERROR, if pointer is NULL
 *	      OK, otherwise.
 */
	if (rxn_ptr == NULL)
		return (RLIB_ERROR);
 ...
 *
 *   Return: RLIB_ERROR, if token not found.
