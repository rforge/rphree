...
static char const svnid[] = "$Id: cvode.c 3985 2010-02-01 16:48:18Z dlpark $";
...
/********************** CVHandleNFlag *******************************
 ...
 CVHandleNFlag returns the constant DO_RLIB_ERROR_TEST, which tells CVStep
