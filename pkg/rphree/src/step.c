...
#if !defined(PHREEQC_CLASS)
static char const svnid[] = "$Id: step.c 3840 2009-12-03 00:47:19Z dlpark $";
...
// MDL: whole new function
/* ---------------------------------------------------------------------- */
int CLASS_QUALIFIER
R_step(LDBLE step_fraction)
/* ---------------------------------------------------------------------- */
{
/*
 ...
 */
	...
	{
		if (reaction_calc(irrev_ptr) == RLIB_ERROR)
		{
			return (RLIB_ERROR);
		}
	}
