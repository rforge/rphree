...
static char const svnidglobal[] =
	"$Id: global.h 4114 2010-02-23 18:36:09Z dlpark $";
#endif
...
// MDL: Rphree
#define RPHREE
EXTERNAL int R_fileprint; 
EXTERNAL int R_verbose; 

//EXTERNAL int database_in_memory;
EXTERNAL int selout[7];
EXTERNAL int R_punch;
EXTERNAL char ** Rbuff; 
EXTERNAL int Rnsim, RsaveSim, RCountLine, Rinput_length, Routdim, Rpunch_dim;
EXTERNAL LDBLE * Rpunch_vec_point;
EXTERNAL int R_do_punch, R_count_punch;

EXTERNAL char ** Rdb_buff; 
EXTERNAL int RCountLine_db, Rdb_length;


// EXTERNAL 
// EXTERNAL int Rcount; 
/* EXTERNAL double * R_out_mol; */
/* EXTERNAL char ** R_out_names; */
...
FILE *error_file;	/* OUTPUT_RLIB_ERROR */
